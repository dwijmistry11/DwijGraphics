Contributing to DwijGraphics
===============================

There are many ways to contribute to DwijGraphics.

  * Submit a feature request or bug, or add to the discussion on the [DwijGraphics issue tracker][is]
  * Submit a [Pull Request][pr] to improve DwijGraphics.
...
If you are new to DwijGraphics development and you don't have push access to the DwijGraphics
...
When submitting a PR, make sure to add a `Cc: @DwijGraphics/developers` comment to
notify DwijGraphics developers of your awesome contributions. Based on the
...
* You do NOT have push access: A DwijGraphics core developer will integrate your PR.
...
[pr]: https://github.com/DwijTech/DwijGraphics/merge_requests
[is]: https://github.com/DwijTech/DwijGraphics/issues
